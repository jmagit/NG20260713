  ...
  describe('notblankValidator', () => {
    ...
    describe('KO', () => {
      it('Solo blancos', () => {
        ...
        expect(result, 'Solo blancos').not.toBeNull()
...
describe('NIFNIEValidator', () => {
  ...
  it(`OK`, async () => {
    ...
    fixture.whenStable().then(() => {
      expect(component.control, 'control').toBeDefined()
      expect(component.control?.value, 'value').toBe(valor)
      expect(component.control?.valid, 'valid').toBe(true)
      expect(component.control?.errors, 'errors').toBeNull()
    })
  })
  ...
  it(`KO`, async () => {
    ...
    expect(component.control, 'control').toBeDefined()
    expect(component.control?.value, 'value').toBe(valor)
    expect(component.control?.invalid, 'invalid').toBe(true)
    expect(component.control?.errors, 'errors').toBeDefined()
    expect(component.control?.errors?.['nifnie'], 'nifnie').toBeDefined()
  })
});
